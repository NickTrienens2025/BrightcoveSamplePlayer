    ...
    var body: some View {
        VStack {
            VStack {
                ...
                case .bcovIMAViewController:
                    BCOVAdsPlayerViewControllerRepresentable(playerModel: playerModel, video: videoItem.video)
                case .native:
        ...
        .toolbar {
            ToolbarItem(placement: .navigation) {
                Button(action: {
                    // IMA ViewController manages its own playback controller
                    if controlType != .bcovIMAViewController,
                       let playbackController = playerModel.playbackController,
        ...
        .onAppear {
            // IMA ViewController handles its own video setup
            if controlType == .bcovIMAViewController {
#if targetEnvironment(simulator)
